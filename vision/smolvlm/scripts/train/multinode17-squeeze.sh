...
MODEL_NAME="HuggingFaceTB/SmolVLM-2.2B-Instruct"
DATA_PATH="scripts/mixtures/onevision_less_mammoth_more_videos_balanced-2.yaml"
DATA_FOLDER="/path/to/user/apollo-dataset/"
RUN_NAME="tiny-v8-onevision-lessmammoth-more-videos_balanced-2"
